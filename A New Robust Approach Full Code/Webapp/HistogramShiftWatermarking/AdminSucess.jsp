...
function val(x)
{
	...
	if(x=="create")
		...
		document.recordcreate.action="fetch";
		document.recordcreate.submit();
		}
	else if(x=="view")
		{
		document.viewrecord.action="viewrecords";
		document.viewrecord.submit();
		}
	else if(x=="partition")
		{
		
		document.datapartition.action="datapartition";
		document.datapartition.submit();
		}
	else if(x=="Threshold")
		{
    ...
    <body>
 <form action="fetch" method="post" name="recordcreate">
 <input type="hidden" name="username" value="<%=username%>"/>
 <input type="hidden" name="userid" value="<%=userid%>"/>
 </form>
<form action="viewrecords" method="post" name="viewrecord">
<input type="hidden" name="username" value="<%=username%>"/>
 <input type="hidden" name="userid" value="<%=userid%>"/>
 </form>
<form action="datapartition" method="post" name="datapartition">
<input type="hidden" name="username" value="<%=username%>"/>
 <input type="hidden" name="userid" value="<%=userid%>"/>
 </form>
 ...
 <input type="hidden" name="userid" value="<%=userid%>"/>
        ...
        <div id="body-bg">
            ...
            <div id="content">
                    ...
                    <div class="row">
                        <div class="col-md-12 portfolio-group no-padding">
                            ...
                            <div class="col-md-3 portfolio-item margin-bottom-40 code">
                                <div onclick="val('create')">
                                        <figure >
                                            <img src="images/Generate_report.png" alt="image1" >
                                            <figcaption>
                                                <h3 class="margin-top-20">GENERATE REPORT</h3>
                                                <span>Is to make the watermark insertion/reading independent of the way the database is stored.</span>
                                            </figcaption>
                                        </figure>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 portfolio-item margin-bottom-40 video">
                                <div>
                                    <a onclick="val('view')">
                                        <figure>
                                            <img src="images/Report_summary.png" alt="image7" >
                                            <figcaption>
                                                <h3 class="margin-top-20">REPORT SUMMARY</h3>
                            ...
                            <div class="col-md-3 portfolio-item margin-bottom-40 audio">
                                <div>
                                    <a onclick="val('partition')">
                                        <figure>
                                            <img src="images/Partition.png" alt="image8" >
                                            <figcaption>
                                                <h3 class="margin-top-20">TUPLE GROUPING</h3>
                                                <span>One solution is to perform the tuple grouping operation prior to watermark insertion.</span>
                                            </figcaption>
                                        </figure>
                                    </a>
                                </div>
                            ...
                            <div class="col-md-3 portfolio-item margin-bottom-40 audio">
                                <div>
                                    <a onclick="val('Threshold')">
                                        <figure>
                                            <img src="images/Threshold.png" alt="image9" >
                                            <figcaption>
                                                <h3 class="margin-top-20">SECURE HASH ALGORITHM</h3>
                                                <span>which is applied to the primary key of the tuple (tu.PK).</span>
                                            </figcaption>
                                        </figure>
                                    </a>
                                </div>
               ...
               <div style="width: 98%;height: 500px;overflow: auto;">
	...
	<%for(int i=0;i<st.size();i++)
      ...
      <tr class="row100 head">
		<th><%=temp.get(0)%></th><th><%=temp.get(1)%></th><th><%=temp.get(2)%></th><th><%=temp.get(3)%></th><th><%=temp.get(4)%></th><th><%=temp.get(5)%></th>
		<th><%=temp.get(6)%></th><th><%=temp.get(7)%></th><th><%=temp.get(8)%></th><th><%=temp.get(9)%></th><th><%=temp.get(10)%></th><th><%=temp.get(11)%></th><th><%=temp.get(12)%></th>
	</tr>
	</thead>
		<% 
		}else{
