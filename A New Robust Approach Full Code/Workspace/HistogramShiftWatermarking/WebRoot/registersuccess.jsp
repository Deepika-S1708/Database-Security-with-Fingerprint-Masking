...
String username=((String)session.getAttribute("username")!=null?(String)request.getAttribute("username"):"");
String userid=((String)session.getAttribute("userid")!=null?(String)session.getAttribute("userid"):"");
String status="";
status = ((String)request.getAttribute("PARTITION")!=null?(String)request.getAttribute("PARTITION"):"");
%>
...
<form action="userviewemb" method="post" name="userencode">
<input type="hidden" name="username" value="<%=username%>"/>
 <input type="hidden" name="userid" value="<%=userid%>"/>
 </form>
<form id="loginform" name="loginform" action="decoding" method="post">
 ...
 <input type="hidden" name="userid" value="<%=userid%>"/>
            ...
            <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        <div class="col-md-12">
                            <h2>Watermark Extraction and Data Recovery</h2>&nbsp; <label id="resmsg" style="color: red;"><%= status%></label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 portfolio-group no-padding">
                            ...
                            <div class="col-md-3 portfolio-item margin-bottom-40 code">
                                <div onclick="val('viewencode')">
                                        <figure >
                                            <img src="images/Generate_report.png" alt="image1" >
                                            <figcaption>
                                                <h3 class="margin-top-20">View Encode Records</h3>
                            ...
                            <%--<div class="col-md-3 portfolio-item margin-bottom-40 video">
                                <div>
                                    <a onclick="val('decode')">
                                        <figure>
                                            <img src="images/Report_summary.png" alt="image7" >
                                            <figcaption>
                                                <h3 class="margin-top-20">Decode Records</h3>
   ...
   <th>SNO</th><th>YEAR</th><th>STAFF</th><th>VECHICLE</th><th>MATERIAL</th><th>DAMAGE</th><th>CUSTOMER</th><th>BRANCHES</th><th>RENTALEXPENSES</th><th>	SALARYAMOUNT_PA</th><th>OTHER_EXPENSES_PA</th><th>ANNUALTURNOVER</th><th>PROFITLOSS</th>
	</tr></thead>
			 <%
