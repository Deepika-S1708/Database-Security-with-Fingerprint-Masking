...
<form action="viewemb2" method="post" name="embedrecords">
 ...
 <input type="hidden" name="userid" value="<%=userid%>"/>
                    ...
                    <div class="row">
                        <div class="col-md-12 portfolio-group no-padding">
                            ...
                            <div class="col-md-3 portfolio-item margin-bottom-40 code">
                                <div onclick="val('watermark')">
                                        <figure >
                                            <img src="images/watermark.png" alt="image1" >
                                            <figcaption>
                            ...
                            <div class="col-md-3 portfolio-item margin-bottom-40 code">
                                <div onclick="val('view')">
                                        <figure >
                                            ...
                                            <figcaption>
                                                <h3 class="margin-top-20">View Records </h3>
		...
		String status1 = (String)request.getAttribute("PARTITION");
		if(status1!=null)
			{
		...
		<th>SNO</th><th>YEAR</th><th>STAFF</th><th>VECHICLE</th><th>MATERIAL</th><th>PROJECTSCOUNT</th>
